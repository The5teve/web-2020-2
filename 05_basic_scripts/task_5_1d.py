...
inp = str(input('Введите имя устройства: '))

try: 
    print('Введите имя параметра (',str(list(london_co[inp].keys())).replace("'","")[1:-1],'): ')
    inp2=input().lower()
    try:
        print(london_co[inp][inp2])
    except KeyError:
        print('Такого параметра нет')
except KeyError:
    print('Неверное имя устройства')